    ...
    <div className="ceratops__head-box">
      <div className="ceratops__head-column">
        <div className="ceratops__head-article">
          ...
          <p>
            ...
            User Research, Interaction Design, Visual Design, User Flows, Rapid
      ...
      <div className="ceratops__head-column">
        <div className="ceratops__head-article">
          ...
          <p>
            This is not a technical post or a tutorial. The web is full of great
            materials on how to design secure cryptocurrency wallets or
            customize user interfaces, written by professionals much smarter
            than me.
          </p>
          <p>
            It&#39;s about how we made the complex simple and easy to
            understand. understand. It&#39;s about how to create a product that
            doesn&#39;t scare you with novelty, but becomes a reliable
