    ...
    <div className="experience">
      ...
      <div className="experience__place">
        ...
        <p className="experience__text">
          ...
          at Web Bunny wasn&#39;t just about aesthetics—it was about making
          design a core driver of business growth.
        </p>
      ...
      <div className="experience__place">
        ...
        <p className="experience__text">
          I create websites and digital products that don&#39;t just look
          pretty, but work for results. In my work, I combine strategy, UX
          research and powerful UI design to help businesses increase conversion
          rates, improve user experience and stand out from the competition.
        </p>
        <div className="experience__date">
          <img src={star} alt="" />
          <p>2021 — Present</p>
